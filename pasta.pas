...
type
   ...
   *)
  TBinaryType = (btCPM, btZX, btZX128, btZXN, btAgon, btCPC);
...
begin
  ...
  if (Binary = btCPM) or (Binary = btCPC) then
  begin
...
begin
  case Binary of
    ...
    btCPC:SupportsFormat := Format = tfBinary;
  end;
end;
